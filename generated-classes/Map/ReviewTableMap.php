...
class ReviewTableMap extends TableMap
{
     ...
     */
    const COL_CLIENT_ID = 'review.client_id';

    /**
     * the column name for the user_id field
     */
    const COL_USER_ID = 'review.user_id';
     ...
     */
    const COL_MESSAGE = 'review.message';

    /**
     * the column name for the created field
     */
    const COL_CREATED = 'review.created';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'ClientId', 'UserId', 'Status', 'Message', 'Created', ),
        self::TYPE_CAMELNAME     => array('id', 'clientId', 'userId', 'status', 'message', 'created', ),
        self::TYPE_COLNAME       => array(ReviewTableMap::COL_ID, ReviewTableMap::COL_CLIENT_ID, ReviewTableMap::COL_USER_ID, ReviewTableMap::COL_STATUS, ReviewTableMap::COL_MESSAGE, ReviewTableMap::COL_CREATED, ),
        self::TYPE_FIELDNAME     => array('id', 'client_id', 'user_id', 'status', 'message', 'created', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'ClientId' => 1, 'UserId' => 2, 'Status' => 3, 'Message' => 4, 'Created' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'clientId' => 1, 'userId' => 2, 'status' => 3, 'message' => 4, 'created' => 5, ),
        self::TYPE_COLNAME       => array(ReviewTableMap::COL_ID => 0, ReviewTableMap::COL_CLIENT_ID => 1, ReviewTableMap::COL_USER_ID => 2, ReviewTableMap::COL_STATUS => 3, ReviewTableMap::COL_MESSAGE => 4, ReviewTableMap::COL_CREATED => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'client_id' => 1, 'user_id' => 2, 'status' => 3, 'message' => 4, 'created' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
  ...
  array (
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ReviewTableMap::COL_CLIENT_ID);
            $criteria->addSelectColumn(ReviewTableMap::COL_USER_ID);
            $criteria->addSelectColumn(ReviewTableMap::COL_STATUS);
            $criteria->addSelectColumn(ReviewTableMap::COL_MESSAGE);
            $criteria->addSelectColumn(ReviewTableMap::COL_CREATED);
        } else {
