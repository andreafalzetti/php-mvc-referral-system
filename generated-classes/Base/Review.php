...
abstract class Review implements ActiveRecordInterface
{
    ...
    public function setClientId($v)
    {
        ...
        if ($this->client_id !== $v) {
            $this->client_id = $v;
            $this->modifiedColumns[ReviewTableMap::COL_CLIENT_ID] = true;
        }
    ...
    public function setUserId($v)
    {
        ...
        if ($this->user_id !== $v) {
            $this->user_id = $v;
            $this->modifiedColumns[ReviewTableMap::COL_USER_ID] = true;
        }
    ...
    public function setMessage($v)
    {
        ...
        if ($this->message !== $v) {
            $this->message = $v;
            $this->modifiedColumns[ReviewTableMap::COL_MESSAGE] = true;
        }
    ...
    public function setCreated($v)
    {
        ...
        if ($this->created !== null || $dt !== null) {
            if ($this->created === null || $dt === null || $dt->format("Y-m-d H:i:s.u") !== $this->created->format("Y-m-d H:i:s.u")) {
                ...
                $this->modifiedColumns[ReviewTableMap::COL_CREATED] = true;
            }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ReviewTableMap::translateFieldName('ClientId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->client_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ReviewTableMap::translateFieldName('UserId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ReviewTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ReviewTableMap::translateFieldName('Message', TableMap::TYPE_PHPNAME, $indexType)];
            $this->message = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ReviewTableMap::translateFieldName('Created', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ReviewTableMap::COL_CLIENT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'client_id';
        }
        if ($this->isColumnModified(ReviewTableMap::COL_USER_ID)) {
            $modifiedColumns[':p' . $index++]  = 'user_id';
        }
        if ($this->isColumnModified(ReviewTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(ReviewTableMap::COL_MESSAGE)) {
            $modifiedColumns[':p' . $index++]  = 'message';
        }
        if ($this->isColumnModified(ReviewTableMap::COL_CREATED)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ReviewTableMap::COL_CLIENT_ID)) {
            $criteria->add(ReviewTableMap::COL_CLIENT_ID, $this->client_id);
        }
        if ($this->isColumnModified(ReviewTableMap::COL_USER_ID)) {
            $criteria->add(ReviewTableMap::COL_USER_ID, $this->user_id);
        }
        if ($this->isColumnModified(ReviewTableMap::COL_STATUS)) {
            $criteria->add(ReviewTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(ReviewTableMap::COL_MESSAGE)) {
            $criteria->add(ReviewTableMap::COL_MESSAGE, $this->message);
        }
        if ($this->isColumnModified(ReviewTableMap::COL_CREATED)) {
            $criteria->add(ReviewTableMap::COL_CREATED, $this->created);
        }
    ...
    {
        if (null !== $this->aClient) {
            $this->aClient->removeReview($this);
        }
        if (null !== $this->aUser) {
